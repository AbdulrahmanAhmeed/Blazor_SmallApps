...
namespace ExpenseTracker.Server.Data
{
    public class ExpenseTrackerServerContext : DbContext
    {
        ...
        public DbSet<ExpenseTracker.Shared.Entities.ExpenseType> ExpenseType { get; set; } = default!;

        public DbSet<ExpenseTracker.Shared.Entities.Expense> Expense { get; set; } = default!;
